...
def calculate_general_ruduce_inter_thread_resource_utilization(out_shape,reduction_shape,out_axis_mapping,reduction_axis_mapping,out_tb_shape,dim_threads,reduce_threads_info, arch,mem_levels,compute_at=1):
# ret=calculate_N_N_elementwise_resource_utilization([20480,20480],[10,160],[10,10], 4,chip,conv_levels)
    ...
    # print("in1_tb_spatial_shape",in1_tb_spatial_shape,"in1_tb_current_step_shape",in1_tb_current_step_shape)
    # print("in2_tb_spatial_shape",in2_tb_spatial_shape,"in2_tb_current_step_shape",in2_tb_current_step_shape)
