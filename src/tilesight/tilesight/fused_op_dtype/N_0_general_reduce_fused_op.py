...
def calculate_N_0_general_ruduce_resource_utilization(out_shape,reduction_shape,out_axis_mapping,reduction_axis_mapping,out_tb_shape,dim_threads, arch,mem_levels,compute_at=1):
# ret=calculate_N_N_elementwise_resource_utilization([20480,20480],[10,160],[10,10], 4,chip,conv_levels)
    ...
    l2_read_io=in1_level[-1]*np.prod(spatial_grids)*np.prod(reduction_grids)*(
