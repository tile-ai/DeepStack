...
def calculate_general_ruduce_resource_utilization(out_shape,reduction_shape,out_axis_mapping,reduction_axis_mapping,out_tb_shape,dim_threads, arch,mem_levels,compute_at=1):
# ret=calculate_N_N_elementwise_resource_utilization([20480,20480],[10,160],[10,10], 4,chip,conv_levels)
    ...
    # Additional case: dwconv has shared spatial axes
    ...
    #     [0],  # Output axis 'n' comes from axis 0 of input1 and is a spatial axis
    #     [2],  # Output axis 'c' comes from both input1 and input2 and is a spatial axis
    #     [0],  # Output axis 'h' comes from axis 2 of input1 and is a spatial axis
    #     [0]   # Output axis 'w' comes from axis 3 of input1 and is a spatial axis
    # ]
