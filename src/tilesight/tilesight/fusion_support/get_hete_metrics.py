def get_hete_metrics(post_data):
    ...
    "Smem Footprint per Thread Block/Bytes": post_data[4],
    ...
    "Tensor Useful Ops": post_data[12] if len(post_data) >= 14 else None,
    "Tensor Padding Ops": post_data[13] if len(post_data) >= 14 else None,
}
