...
from mosaic.dse_space.case_study.llm_arch_deep_to_wide import LLM_DEEP_TO_WIDE_1, LLM_DEEP_TO_WIDE_2, LLM_DEEP_TO_WIDE_3, LLM_DEEP_TO_WIDE_4
...
def task_decoding_combination():
    ...
    for model_arch in [LLM_DEEP_TO_WIDE_1(), LLM_DEEP_TO_WIDE_2(), LLM_DEEP_TO_WIDE_3(), LLM_DEEP_TO_WIDE_4()]:
        for BS in BS_LIST:
...
MODEL_REG = {
    ...
    "LLM_DEEP_TO_WIDE_1": LLM_DEEP_TO_WIDE_1,
    "LLM_DEEP_TO_WIDE_2": LLM_DEEP_TO_WIDE_2,
    "LLM_DEEP_TO_WIDE_3": LLM_DEEP_TO_WIDE_3,
    "LLM_DEEP_TO_WIDE_4": LLM_DEEP_TO_WIDE_4,
}
...
if __name__ == "__main__":
    ...
    run_dir = os.path.join("./deep_to_wide_prefill_runs", run_tag)
