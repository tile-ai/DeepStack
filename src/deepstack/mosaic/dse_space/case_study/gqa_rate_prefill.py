...
# from .llm_arch_deep_to_wide import LLM_GQA_RATE_1, LLM_GQA_RATE_2, LLM_GQA_RATE_3, LLM_GQA_RATE_4
# from mosaic.dse_space.case_study.llm_arch_gqa_rate import LLM_GQA_RATE_1, LLM_GQA_RATE_2, LLM_GQA_RATE_3,LLM_GQA_RATE_3_2, LLM_GQA_RATE_4
from mosaic.dse_space.case_study.llm_arch_gqa_rate_llama import LLM_GQA_RATE_1_LLAMA, LLM_GQA_RATE_2_LLAMA, LLM_GQA_RATE_3_LLAMA, LLM_GQA_RATE_4_LLAMA, LLM_GQA_RATE_5_LLAMA, LLM_GQA_RATE_6_LLAMA, LLM_GQA_RATE_7_LLAMA
...
def task_decoding_combination():
    ...
    # for model_arch in [LLM_GQA_RATE_1(), LLM_GQA_RATE_2(), LLM_GQA_RATE_3(), LLM_GQA_RATE_4()]:
    for model_arch in [LLM_GQA_RATE_1_LLAMA(), LLM_GQA_RATE_2_LLAMA(), LLM_GQA_RATE_3_LLAMA(), LLM_GQA_RATE_4_LLAMA(), LLM_GQA_RATE_5_LLAMA(), LLM_GQA_RATE_6_LLAMA(), LLM_GQA_RATE_7_LLAMA()]:
        for BS in BS_LIST:
...
def task_prefill_combination():
    ...
    # for model_arch in [LLM_GQA_RATE_3_2()]:
    # for model_arch in [LLM_GQA_RATE_1(), LLM_GQA_RATE_2(), LLM_GQA_RATE_3(), LLM_GQA_RATE_4()]:
    for model_arch in [LLM_GQA_RATE_2_LLAMA(), LLM_GQA_RATE_3_LLAMA(), LLM_GQA_RATE_4_LLAMA(), LLM_GQA_RATE_5_LLAMA()]:
    # for model_arch in [LLM_GQA_RATE_1_LLAMA(), LLM_GQA_RATE_2_LLAMA(), LLM_GQA_RATE_3_LLAMA(), LLM_GQA_RATE_4_LLAMA(), LLM_GQA_RATE_5_LLAMA(), LLM_GQA_RATE_6_LLAMA(), LLM_GQA_RATE_7_LLAMA()]:
        for BS in BS_LIST:
            if TASK_MAX_SEQ > INPUT_SEQ:
                task_combinations.append((model_arch, BS, INPUT_SEQ, TASK_MAX_SEQ, PARALLEL_DECODING))
...
MODEL_REG = {
    "LLM_GQA_RATE_1_LLAMA": LLM_GQA_RATE_1_LLAMA,
    "LLM_GQA_RATE_2_LLAMA": LLM_GQA_RATE_2_LLAMA,
    "LLM_GQA_RATE_3_LLAMA": LLM_GQA_RATE_3_LLAMA,
    "LLM_GQA_RATE_4_LLAMA": LLM_GQA_RATE_4_LLAMA,
    "LLM_GQA_RATE_5_LLAMA": LLM_GQA_RATE_5_LLAMA,
    "LLM_GQA_RATE_6_LLAMA": LLM_GQA_RATE_6_LLAMA,
    "LLM_GQA_RATE_7_LLAMA": LLM_GQA_RATE_7_LLAMA,
}
...
if __name__ == "__main__":
    ...
    run_dir = os.path.join("./gqa_rate_prefill_llama_runs", run_tag)
