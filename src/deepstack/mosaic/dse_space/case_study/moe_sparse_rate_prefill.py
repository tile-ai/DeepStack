...
def dse_1(run_dir, num_workers):
    ...
    for task_combination in task_combinations:
        ...
        if model_arch.__class__.__name__ == "DeepSeekV3":
            npz_trace_file = str(project_root / "data" / "routing" / "deepseek_v3.npz")
        elif model_arch.__class__.__name__ == "Qwen3_235b_a22b":
            npz_trace_file = str(project_root / "data" / "routing" / "qwen3_235b.npz")
            ...
            npz_trace_file = npz_trace_file = str(project_root / "data" / "routing" / "qwen3_235b.npz")
