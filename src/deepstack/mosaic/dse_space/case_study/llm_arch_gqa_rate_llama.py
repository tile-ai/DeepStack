...
class LLM_GQA_RATE_1_LLAMA(LLM_Arch):
    def __init__(self):
...
class LLM_GQA_RATE_2_LLAMA(LLM_Arch):
    def __init__(self):
...
class LLM_GQA_RATE_3_LLAMA(LLM_Arch):
    def __init__(self):
...
class LLM_GQA_RATE_4_LLAMA(LLM_Arch):
    def __init__(self):
...
class LLM_GQA_RATE_5_LLAMA(LLM_Arch):
    def __init__(self):
...
class LLM_GQA_RATE_6_LLAMA(LLM_Arch):
    def __init__(self):
...
class LLM_GQA_RATE_7_LLAMA(LLM_Arch):
    def __init__(self):
...
if __name__ == "__main__":
    model_arch = LLM_GQA_RATE_1_LLAMA()
    print(get_model_weight_size(model_arch))
    model_arch = LLM_GQA_RATE_2_LLAMA()
    print(get_model_weight_size(model_arch))
    model_arch = LLM_GQA_RATE_3_LLAMA()
    print(get_model_weight_size(model_arch))
    model_arch = LLM_GQA_RATE_4_LLAMA()
    print(get_model_weight_size(model_arch))
    model_arch = LLM_GQA_RATE_5_LLAMA()
    print(get_model_weight_size(model_arch))
