...
# from .llm_arch_deep_to_wide import LLM_DEEP_TO_WIDE_1, LLM_DEEP_TO_WIDE_2, LLM_DEEP_TO_WIDE_3, LLM_DEEP_TO_WIDE_4
...
if __name__ == "__main__":
    ...
    run_dir = os.path.join("./deep_to_wide_decode_runs", run_tag)
