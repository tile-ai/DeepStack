from mosaic.dse_space.arch_noc_combinations import arch_noc_combinations1110,h100x32_arch_noc_combinations, h100_8_to_64_arch_noc_combinations
...
def _compute_time_row(args):
    ...
    # arch, noc = h100x32_arch_noc_combinations()[combo_idx]
...
def dse_1(run_dir, num_workers):
    ...
    # from mosaic.arch import H100_SCALED, H200_SCALED
    # from mosaic.noc.noc_config_set import h100x32_strong, h100x32_medium
    # combinations = [[H100_SCALED(), h100x32_strong()], [H200_SCALED(), h100x32_strong()]]
    combinations = h100x32_arch_noc_combinations()
    
    parallel_schemes = all_parallel_schemes(32)
