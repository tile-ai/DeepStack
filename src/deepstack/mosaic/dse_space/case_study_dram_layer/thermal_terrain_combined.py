"""
thermal_terrain_combined.py — 2×2 thermal terrain: Prefill (top) + Decode (bottom), BS=4 & 1024.

Usage:
    python3 thermal_terrain_combined.py
...
Outputs into lfs/:
    - thermal_terrain_combined.{png,pdf}
"""
...
def main():
    ...
    print("=== Combined Thermal Terrain (Scaled STPS) ===")
    ...
    ], out_dir, "thermal_terrain_scaled_pf_dc_bs1024")

    # Figure 2: Decode BS=4 + Decode BS=1024
    _make_figure([
        (df_decode, 4,    "Decode, BS = 4"),
        (df_decode, 1024, "Decode, BS = 1024"),
    ], out_dir, "thermal_terrain_scaled_dc_bs4_1024")
