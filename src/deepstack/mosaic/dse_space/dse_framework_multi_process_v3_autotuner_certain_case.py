...
def dse_1(run_dir, num_workers):
    ...
    combinations = [[stacked_gpu_wgmma(), torus_mesh_mesh_3()],
                    [stacked_gpu_wgmma(), torus_mesh_switch_8()],
                    [stacked_gpu_wgmma(), torus_mesh_switch_7()],
                    [stacked_gpu_high_l1(), torus_mesh_mesh_3()],
                    [stacked_gpu_high_l1(), torus_mesh_switch_8()],
                    [stacked_gpu_high_l1(), torus_mesh_switch_7()],
                    [stacked_gpu_large_matrix(), torus_mesh_mesh_3()],
                    [stacked_gpu_large_matrix(), torus_mesh_switch_8()],
                    [stacked_gpu_large_matrix(), torus_mesh_switch_7()],
    ]
    ...
    # 4	16	16	1	1	1	1	FALSE	4

    parallel_schemes = [ParallelScheme(tp=4, ep=16, sp=1, cp=1, dp=1, pp=4, fsdp=False),
                        ParallelScheme(tp=4, ep=32, sp=1, cp=1, dp=1, pp=2, fsdp=False),
                        ParallelScheme(tp=4, ep=8, sp=1, cp=1, dp=1, pp=8, fsdp=False),
                        ParallelScheme(tp=4, ep=4, sp=1, cp=1, dp=1, pp=16, fsdp=False),
                        ParallelScheme(tp=4, ep=2, sp=1, cp=1, dp=1, pp=32, fsdp=False),
                        ParallelScheme(tp=2, ep=32, sp=1, cp=1, dp=1, pp=4, fsdp=False),
    ]
