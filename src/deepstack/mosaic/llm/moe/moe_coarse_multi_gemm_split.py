...
def moe_coarse_gate_shared_all_to_all(bs:int, seq:int, hidden:int, moe_down_hidden:int, parallel:ParallelScheme, next_parallel:ParallelScheme, expert_bytes:OpBytes, gate_bytes:OpBytes, num_shared_experts:int, num_routed_experts:int, num_activated_experts:int, routing_array:np.ndarray, granularity:Modeling_Granularity, single_chip:Arch, noc_hierarchy:Hierarchy):
    ...
    def shared_experts():
        ...
        time_shared_experts, waves_shared_experts = swiglu_coarse_by_token(shard_tokens, hidden, moe_down_hidden, transformed_parallel, transformed_parallel, expert_bytes, granularity, single_chip, noc_hierarchy)
...
def moe_coarse(bs:int, seq:int, hidden:int, moe_down_hidden:int, parallel:ParallelScheme, next_parallel:ParallelScheme, expert_bytes:OpBytes, gate_bytes:OpBytes, num_shared_experts:int, num_routed_experts:int, num_activated_experts:int, routing_array:np.ndarray, granularity:Modeling_Granularity, single_chip:Arch, noc_hierarchy:Hierarchy):
    ...
    time_gate_shared_all_to_all = moe_coarse_gate_shared_all_to_all(bs, seq, hidden, moe_down_hidden, parallel, next_parallel, expert_bytes, gate_bytes, num_shared_experts, num_routed_experts, num_activated_experts, routing_array, granularity, single_chip, noc_hierarchy)
    
    time_routed_experts = moe_coarse_routed_experts_all_to_all(bs, seq, hidden, moe_down_hidden, parallel, next_parallel, expert_bytes, gate_bytes, num_shared_experts, num_routed_experts, num_activated_experts, routing_array, granularity, single_chip, noc_hierarchy)

    time_token_weighted_summation = moe_coarse_token_weighted_summation(bs, seq, hidden, moe_down_hidden, parallel, next_parallel, expert_bytes, gate_bytes, num_shared_experts, num_routed_experts, num_activated_experts, routing_array, granularity, single_chip, noc_hierarchy)
