...
The package metadata describes the mixed distribution. Python source remains
Apache-2.0; the four bundled shared objects retain their separate proprietary
license and adjacent `.license` files.
